    ...
    (function(e) {
            ...
            var a,
                u = {
                    adapter: ('undefined' != typeof XMLHttpRequest
                        ? (a = r(19))
                        : 'undefined' != typeof process && (a = r(24)),
                    a),
                    transformRequest: [
                        function(e, t) {
                            return (
        ...
        function(e, t, r) {
            ...
            function l(e, t) {
                u.call(this),
                    ...
                    e.host &&
                        (e.hostname || (e.hostname = e.host), delete e.host),
            ...
            function m(e) {
                ...
                return (
                    Object.keys(e).forEach(function(s) {
                        var i = s + ':',
                            u = (r[i] = e[s]),
                            f = (t[s] = Object.create(u))
                        ;(f.request = function(e, s, u) {
                            if ('string' == typeof e) {
                                var f = e
                                try {
                                    e = y(new o(f))
                                ...
                                o && e instanceof o
                                    ? (e = y(e))
                                    : ((u = s), (s = e), (e = { protocol: i }))
                            return (
                                'function' == typeof s && ((u = s), (s = null)),
                                ((s = Object.assign(
                                    {
            ...
            ;['abort', 'aborted', 'error', 'socket', 'timeout'].forEach(
                ...
                (l.prototype.setTimeout = function(e, t) {
                    if ((t && this.once('timeout', t), this.socket)) d(this, e)
                    else {
                        var r = this
                ...
                (l.prototype._performRequest = function() {
                    ...
                    if (t) {
                        ...
                        for (var s in ((this._currentUrl = n.format(
                            this._options
                        )),
                        ...
                        this.emit(
                            'error',
                            new Error('Unsupported protocol ' + e)
                        )
                }),
                ...
                function n(e) {
                    ...
                    function i() {
                        if (i.enabled) {
                            ...
                            var c = 0
                            ;(t[0] = t[0].replace(/%([a-zA-Z%])/g, function(
                                e,
                                r
                            ) {
                                if ('%%' === e) return e
                                ...
                                if ('function' == typeof o) {
                                    var i = t[c]
                                    ;(e = o.call(s, i)), t.splice(c, 1), c--
                                }
                                return e
                            })),
                                n.formatArgs.call(s, t),
                                (s.log || n.log).apply(s, t)
                        }
                    }
                    return (
                        (i.namespace = e),
        ...
        function(e, t, r) {
            ...
            ;(o.prototype = new Error()),
                ...
                (e.exports = function(e) {
                    for (
                        var t, r, s = String(e), i = '', a = 0, u = n;
                        s.charAt(0 | a) || ((u = '='), a % 1);
                        i += u.charAt(63 & (t >> (8 - (a % 1) * 8)))
                    ) {
                        if ((r = s.charCodeAt((a += 0.75))) > 255) throw new o()
                        t = (t << 8) | r
                    }
                    return i
                })
            ...
            e.exports = function(e) {
                return new Promise(function(t, r) {
                    ...
                    if (
                        ...
                        else if (n.isArrayBuffer(g))
                            g = new Buffer(new Uint8Array(g))
                        else {
                            if (!n.isString(g))
                                return r(
                                    d(
                    ...
                    v && delete y.Authorization
                    var x = 'https:' === w,
                        _ = x ? e.httpsAgent : e.httpAgent,
                        R = {
                            path: s(
                                C.path,
                                e.params,
                    ...
                    e.socketPath
                        ...
                        : ((R.hostname = C.hostname), (R.port = C.port))
                    var E,
                        F = e.proxy
                    if (!F && !1 !== F) {
                        var O = w.slice(0, -1) + '_proxy',
                            A = process.env[O] || process.env[O.toUpperCase()]
                        if (A) {
                            var B = f.parse(A)
                            if (
                                ((F = { host: B.hostname, port: B.port }),
                                B.auth)
                            ) {
                                var S = B.auth.split(':')
                                F.auth = { username: S[0], password: S[1] }
                            }
                        }
                    }
                    if (
                        ...
                        var T = new Buffer(
                            F.auth.username + ':' + F.auth.password,
                            'utf8'
                        ).toString('base64')
                    ...
                    j.on('error', function(t) {
                        j.aborted || r(h(t, e, null, j))
                    }),
                        e.timeout &&
                            !m &&
                        ...
                        e.cancelToken &&
                            e.cancelToken.promise.then(function(e) {
                                j.aborted || (j.abort(), r(e))
                            }),
                        n.isStream(g) ? g.pipe(j) : j.end(g)
                })
            }
        },
        function(e, t) {
        ...
        function(e, t, r) {
            ...
            ;(t.init = function(e) {
                e.inspectOpts = {}
                for (
                    var r = Object.keys(t.inspectOpts), n = 0;
                    n < r.length;
                    n++
                )
        ...
        function(e) {
            e.exports = {
                ...
                _requiredBy: ['/'],
                _resolved:
                    'https://registry.npmjs.org/axios/-/axios-0.18.0.tgz',
                _shasum: '32d53e4851efdc0a11993b6cd000789d70c05102',
                _spec: 'axios@^0.18.0',
                _where: '/Users/Owner/printworksapparel',
        ...
        function(e, t, r) {
            ...
            t.handler = function(e, t, r) {
                const { API_URL: o, API_KEY: s } = process.env,
                    i = 'Bearer ' + s
                'GET' == e.httpMethod && a()
                const a = () => {
                        n.get(o, {
                            headers: { Authorization: i, type: 'GET' },
                        }).then(e => u(e.data).catch(e => u(e)))
                    },
                    u = e => {
                        r(null, {
                            statusCode: 200,
